...
class ParagraphsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paragraph" do
    assert_difference('Paragraph.count') do
      post paragraphs_url, params: { paragraph: { body: @paragraph.body, chapter_id: @paragraph.chapter_id, word_count: @paragraph.word_count, words: @paragraph.words } }
    end
  ...
  test "should update paragraph" do
    patch paragraph_url(@paragraph), params: { paragraph: { body: @paragraph.body, chapter_id: @paragraph.chapter_id, word_count: @paragraph.word_count, words: @paragraph.words } }
